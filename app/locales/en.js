export default {
  ...
  challenges: {
    ...
    reasons: {
      ...
      piscatorsGuild: "Piscators' Guild scored",
      piscary: "Piscaries with the Market bonus: {have}/{need}",
    },
    badgeLabels: {
      cottages: "Cottages",
    ...
    edgeOfTheWorld: {
      ...
      rule1: "Piscary replaces Windmill: whenever you would build a Windmill, build a Piscary instead.",
      rule2: "Piscary requires 2 Labourers for Activation.",
      rule3: "Piscary scores 3 RP, and +1 RP per adjacent active Market.",
      rule4: "Piscators' Guild replaces the Windmillers' Guild.",
      rule5: "Piscators' Guild scores 15 RP if you have at least 1 active Piscary on each outer edge (top, bottom, left, and right). A corner Piscary counts for only one edge of your choice.",
      victory1: "Achieve at least 80 RP.",
      victory2: "Score the Piscators' Guild (15 RP).",
      victory3: "Score all Piscaries with the +1 RP Market bonus.",
    },
    unrestLabel: "Unrest",
