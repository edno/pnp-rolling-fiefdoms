export default {
  ...
  turn: {
    ...
    nonActiveWithSwap: "{base} Utilisez le <strong>bouton d'échange</strong> pour permuter les paires.",
    ...
    doubleWindroseRolledBanner: 'Double <img src="assets/img/windrose.svg" alt="rose des vents" class="inline-icon"> obtenue ; appuyez sur {rollBtn} pour relancer.',
  ...
  challenges: {
    ...
    result: {
      ...
      scoreComparison: "Score final : {score} PR",
    },
    reasons: {
      ...
      piscatorsGuild: "Guilde des Pêcheurs marquée",
      piscary: "Pêcheries avec le bonus de Halle : {have}/{need}",
    },
    badgeLabels: {
      cottages: "Logis",
    ...
    edgeOfTheWorld: {
      ...
      rule1: "La Pêcherie remplace le Moulin : chaque fois que vous devriez construire un Moulin, construisez une Pêcherie à la place.",
      rule2: "La Pêcherie nécessite 2 Ouvriers pour l'Activation.",
      rule3: "La Pêcherie marque 3 PR, et +1 PR par Halle active adjacente.",
      rule4: "La Guilde des Pêcheurs remplace la Guilde des Meuniers.",
      rule5: "La Guilde des Pêcheurs marque 15 PR si vous avez au moins 1 Pêcherie active sur chaque bord extérieur (haut, bas, gauche et droite). Une Pêcherie en coin ne compte que pour un seul bord, au choix.",
      victory1: "Obtenez au moins 80 PR.",
      victory2: "Marquez la Guilde des Pêcheurs (15 PR).",
      victory3: "Marquez toutes les Pêcheries avec le bonus de +1 PR de Halle.",
    },
    ...
    unrestReasonVagrants: "Vagabonds > 8",
    barricadesRaised: "Barricades érigées ! Choisissez une case Population à hachurer.",
    barricadesPostponed: "L'Agitation a atteint son maximum, mais toutes les cases Population sont occupées — Barricades reportées.",
